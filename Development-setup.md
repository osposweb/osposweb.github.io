...
In case you face an issue during the npm install (e.g. phantomjs@1.9.20 install: node install.js) do `apt-get install nodejs-legacy` and run again `npm install --only=dev` .
