After sussessfully install and login in, will display a started welcome menu screen, **first step its configure the store** at the **Office module** as the screen shot shows:
