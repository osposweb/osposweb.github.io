...
| Printers  | Depends entirely of the browser and OS, wiki info at [OSPOS Printing wiki page (click here)](Printing), recommended Star TSP 143IIU or Epson TM-88VI printers should work fine. If you consider buying one on Amazon then please [use our link](https://amzn.to/38XX2VL) to contribute back to the project |
